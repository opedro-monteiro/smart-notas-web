...
const plans: Plan[] = [
  {
    ...
    features: [
      "Lembretes próprios ilimitados",
      "5 cobranças p/ terceiros/mês",
      "Push + E-mail",
      "Dashboard básico",
    ],
    cta: "Começar grátis",
  ...
  },
  {
    ...
    extra: "+ R$ 0,20/msg excedente",
    features: [
      "Lembretes próprios ilimitados",
      "1.000 cobranças p/ terceiros/mês",
      "WhatsApp + SMS + E-mail",
      "Múltiplos usuários",
      "Gerente dedicado",
      "SLA garantido",
